...
class LinesControllerTest < ActionController::TestCase
  ...
  test "should create line" do
    assert_difference('Line.count') do
      post :create, line: { description: @line.description, manufacturer: @line.manufacturer, name: @line.name }
    end
  ...
  test "should update line" do
    put :update, id: @line, line: { description: @line.description, manufacturer: @line.manufacturer, name: @line.name }
    assert_redirected_to line_path(assigns(:line))
  end
